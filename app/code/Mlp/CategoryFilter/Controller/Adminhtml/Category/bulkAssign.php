...
namespace Mlp\CategoryFilter\Controller\Adminhtml\Source;

use Magento\Backend\App\Action;
use Magento\Framework\App\ResponseInterface;
use Magento\Framework\Controller\ResultInterface;
use Mlp\CategoryFilter\Controller\Adminhtml\Bulk\BulkPageProcessor;
...
class BulkAssign extends Action
{
    ...
    {
        return $this->processBulkPage->execute(__('Bulk category assignment'), false);
    }
}
