<?php
namespace Mlp\Cli\Console\Command\MlpAttributeSet;

/**
 * Interceptor class for @see \Mlp\Cli\Console\Command\MlpAttributeSet
 */
class Interceptor extends \Mlp\Cli\Console\Command\MlpAttributeSet implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Eav\Model\AttributeSetManagement $attributeSetManagement, \Magento\Eav\Model\Entity\Attribute\SetFactory $attributeSetFactory, \Magento\Eav\Model\Entity\TypeFactory $eavTypeFactory)
    {
        $this->___init();
        parent::__construct($attributeSetManagement, $attributeSetFactory, $eavTypeFactory);
    }
