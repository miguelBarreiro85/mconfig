<?php
namespace Mlp\Cli\Console\Command\Orima;

/**
 * Interceptor class for @see \Mlp\Cli\Console\Command\Orima
 */
class Interceptor extends \Mlp\Cli\Console\Command\Orima implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Mlp\Cli\Helper\SqlHelper $sqlHelper, \Magento\Framework\Registry $registry, \Magento\Framework\Filesystem\DirectoryList $directory, \Mlp\Cli\Helper\Category $categoryManager, \Magento\Framework\App\State $state, \Mlp\Cli\Model\ProdutoInterno $productoInterno, \Mlp\Cli\Helper\LoadCsv $loadCsv, \Magento\Catalog\Api\ProductRepositoryInterface $productRepository)
    {
        $this->___init();
        parent::__construct($sqlHelper, $registry, $directory, $categoryManager, $state, $productoInterno, $loadCsv, $productRepository);
    }
