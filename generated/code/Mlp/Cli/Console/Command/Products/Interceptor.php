<?php
namespace Mlp\Cli\Console\Command\Products;

/**
 * Interceptor class for @see \Mlp\Cli\Console\Command\Products
 */
class Interceptor extends \Mlp\Cli\Console\Command\Products implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\InventoryApi\Api\SourceItemRepositoryInterface $sourceItemRepositoryI, \Magento\Framework\App\ResourceConnection $resourceConnection, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, \Mlp\Cli\Model\ProdutoInterno $productoInterno, \Magento\Catalog\Api\ProductRepositoryInterface $productRepository, \Magento\Framework\Api\SearchCriteriaBuilder $searchCriteriaBuilder, \Magento\Framework\Api\FilterBuilder $filterBuilder, \Magento\Framework\Api\SortOrderBuilder $sortOrderBuilder, \Magento\Catalog\Model\ResourceModel\Product $productResource, \Magento\Framework\App\State $state, \Mlp\Cli\Helper\Data $dataAttributeOptions, \Mlp\Cli\Console\Command\Sorefoz $sorefoz, \Magento\Framework\Filesystem\DirectoryList $directory, \Mlp\Cli\Helper\Category $categoryManager, \Mlp\Cli\Helper\LoadCsv $loadCsv)
    {
        $this->___init();
        parent::__construct($sourceItemRepositoryI, $resourceConnection, $productCollectionFactory, $productoInterno, $productRepository, $searchCriteriaBuilder, $filterBuilder, $sortOrderBuilder, $productResource, $state, $dataAttributeOptions, $sorefoz, $directory, $categoryManager, $loadCsv);
    }
