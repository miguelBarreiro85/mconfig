<?php
namespace Mlp\Cli\Console\Command\Expert;

/**
 * Interceptor class for @see \Mlp\Cli\Console\Command\Expert
 */
class Interceptor extends \Mlp\Cli\Console\Command\Expert implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Filesystem\DirectoryList $directory, \Mlp\Cli\Helper\SqlHelper $sqlHelper, \Magento\Framework\App\State $state, \Mlp\Cli\Model\ProdutoInterno $productoInterno, \Mlp\Cli\Helper\LoadCsv $loadCsv, \Magento\Catalog\Api\ProductRepositoryInterface $productRepository, \Mlp\Cli\Helper\imagesHelper $imagesHelper)
    {
        $this->___init();
        parent::__construct($directory, $sqlHelper, $state, $productoInterno, $loadCsv, $productRepository, $imagesHelper);
    }
