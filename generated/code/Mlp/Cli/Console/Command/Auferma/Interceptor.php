<?php
namespace Mlp\Cli\Console\Command\Auferma;

/**
 * Interceptor class for @see \Mlp\Cli\Console\Command\Auferma
 */
class Interceptor extends \Mlp\Cli\Console\Command\Auferma implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Mlp\Cli\Helper\imagesHelper $imagesHelper, \Mlp\Cli\Helper\SqlHelper $sqlHelper, \Magento\Framework\Filesystem\DirectoryList $directory, \Mlp\Cli\Helper\Category $categoryManager, \Magento\Framework\App\State $state, \Mlp\Cli\Model\ProdutoInterno $productoInterno, \Magento\Catalog\Api\ProductRepositoryInterface $productRepositoryInterface, \Mlp\Cli\Helper\LoadCsv $loadCsv)
    {
        $this->___init();
        parent::__construct($imagesHelper, $sqlHelper, $directory, $categoryManager, $state, $productoInterno, $productRepositoryInterface, $loadCsv);
    }
