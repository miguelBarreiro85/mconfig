<?php
namespace Mlp\Cli\Console\Command\Sorefoz;

/**
 * Interceptor class for @see \Mlp\Cli\Console\Command\Sorefoz
 */
class Interceptor extends \Mlp\Cli\Console\Command\Sorefoz implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Filesystem\DirectoryList $directory, \Mlp\Cli\Helper\SqlHelper $sqlHelper, \Magento\Framework\App\State $state, \Mlp\Cli\Model\ProdutoInterno $produtoInterno, \Magento\Catalog\Api\ProductRepositoryInterface $productRepositoryInterface, \Mlp\Cli\Helper\LoadCsv $loadCsv, \Mlp\Cli\Helper\imagesHelper $imagesHelper, \Mlp\Cli\Helper\Sorefoz\SorefozCategories $sorefozCategories)
    {
        $this->___init();
        parent::__construct($directory, $sqlHelper, $state, $produtoInterno, $productRepositoryInterface, $loadCsv, $imagesHelper, $sorefozCategories);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSorefozData');
        return $pluginInfo ? $this->___callPlugins('setSorefozData', func_get_args(), $pluginInfo) : parent::setSorefozData($data, $logger);
    }
