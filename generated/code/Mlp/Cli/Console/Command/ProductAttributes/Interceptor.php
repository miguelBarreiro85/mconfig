<?php
namespace Mlp\Cli\Console\Command\ProductAttributes;

/**
 * Interceptor class for @see \Mlp\Cli\Console\Command\ProductAttributes
 */
class Interceptor extends \Mlp\Cli\Console\Command\ProductAttributes implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($eavSetupFactory);
    }
