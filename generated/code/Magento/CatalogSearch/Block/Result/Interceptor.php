...
class Interceptor extends \Magento\CatalogSearch\Block\Result implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getListBlock');
        return $pluginInfo ? $this->___callPlugins('getListBlock', func_get_args(), $pluginInfo) : parent::getListBlock();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setListModes');
        return $pluginInfo ? $this->___callPlugins('setListModes', func_get_args(), $pluginInfo) : parent::setListModes();
    }
    ...
    public function getProductListHtml()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getProductListHtml', func_get_args(), $pluginInfo) : parent::getProductListHtml();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSearchQueryText');
        return $pluginInfo ? $this->___callPlugins('getSearchQueryText', func_get_args(), $pluginInfo) : parent::getSearchQueryText();
    }
    ...
    public function getResultCount()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getResultCount', func_get_args(), $pluginInfo) : parent::getResultCount();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNoResultText');
        return $pluginInfo ? $this->___callPlugins('getNoResultText', func_get_args(), $pluginInfo) : parent::getNoResultText();
    }
