...
class Interceptor extends \Mageplaza\BannerSlider\Model\ResourceModel\Slider\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addIdFilter($sliderIds)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addIdFilter', func_get_args(), $pluginInfo) : parent::addIdFilter($sliderIds);
    }
    ...
    public function addActiveFilter($customerGroup = null, $storeId = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addActiveFilter', func_get_args(), $pluginInfo) : parent::addActiveFilter($customerGroup, $storeId);
    }
