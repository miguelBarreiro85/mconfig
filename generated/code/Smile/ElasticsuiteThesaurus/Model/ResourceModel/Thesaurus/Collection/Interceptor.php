...
class Interceptor extends \Smile\ElasticsuiteThesaurus\Model\ResourceModel\Thesaurus\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setTermFilter');
        return $pluginInfo ? $this->___callPlugins('setTermFilter', func_get_args(), $pluginInfo) : parent::setTermFilter($term);
    }
