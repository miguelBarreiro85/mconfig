...
class Interceptor extends \Smile\ElasticsuiteCatalogOptimizer\Model\ResourceModel\Optimizer\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setStoreId($store)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setStoreId', func_get_args(), $pluginInfo) : parent::setStoreId($store);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSearchContainersFilter');
        return $pluginInfo ? $this->___callPlugins('addSearchContainersFilter', func_get_args(), $pluginInfo) : parent::addSearchContainersFilter($searchContainers);
    }
    ...
    public function addIsActiveFilter($date = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addIsActiveFilter', func_get_args(), $pluginInfo) : parent::addIsActiveFilter($date);
    }
