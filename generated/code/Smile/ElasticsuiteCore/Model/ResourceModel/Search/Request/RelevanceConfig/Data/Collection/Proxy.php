...
/**
 * Proxy class for @see \Smile\ElasticsuiteCore\Model\ResourceModel\Search\Request\RelevanceConfig\Data\Collection
 */
class Proxy extends \Smile\ElasticsuiteCore\Model\ResourceModel\Search\Request\RelevanceConfig\Data\Collection implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * Proxied instance
     *
     * @var \Smile\ElasticsuiteCore\Model\ResourceModel\Search\Request\RelevanceConfig\Data\Collection
     */
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Smile\\ElasticsuiteCore\\Model\\ResourceModel\\Search\\Request\\RelevanceConfig\\Data\\Collection', $shared = true)
    {
     ...
     *
     * @return \Smile\ElasticsuiteCore\Model\ResourceModel\Search\Request\RelevanceConfig\Data\Collection
     */
    ...
    {
        return $this->_getSubject()->addScopeFilter($scope, $scopeCode, $section);
    }
