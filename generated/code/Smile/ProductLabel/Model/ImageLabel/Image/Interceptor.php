<?php
namespace Smile\ProductLabel\Model\ImageLabel\Image;

/**
 * Interceptor class for @see \Smile\ProductLabel\Model\ImageLabel\Image
 */
class Interceptor extends \Smile\ProductLabel\Model\ImageLabel\Image implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isTmpFileAvailable');
        return $pluginInfo ? $this->___callPlugins('isTmpFileAvailable', func_get_args(), $pluginInfo) : parent::isTmpFileAvailable($value);
    }
