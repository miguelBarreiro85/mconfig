<?php
namespace Smile\ProductLabel\Model\ResourceModel\ProductLabel\Grid\Collection;

/**
 * Interceptor class for @see \Smile\ProductLabel\Model\ResourceModel\ProductLabel\Grid\Collection
 */
class Interceptor extends \Smile\ProductLabel\Model\ResourceModel\ProductLabel\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllAttributeIds');
        return $pluginInfo ? $this->___callPlugins('getAllAttributeIds', func_get_args(), $pluginInfo) : parent::getAllAttributeIds();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllOptionIds');
        return $pluginInfo ? $this->___callPlugins('getAllOptionIds', func_get_args(), $pluginInfo) : parent::getAllOptionIds();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addAttributeFilter');
        return $pluginInfo ? $this->___callPlugins('addAttributeFilter', func_get_args(), $pluginInfo) : parent::addAttributeFilter($attribute);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addAttributeSetIdFilter');
        return $pluginInfo ? $this->___callPlugins('addAttributeSetIdFilter', func_get_args(), $pluginInfo) : parent::addAttributeSetIdFilter($attributeSetIds);
    }
