...
class Interceptor extends \Smile\ElasticsuiteCatalog\Model\ResourceModel\Product\FilterableAttribute\Category\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setCategory');
        return $pluginInfo ? $this->___callPlugins('setCategory', func_get_args(), $pluginInfo) : parent::setCategory($category);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'applyCategory');
        return $pluginInfo ? $this->___callPlugins('applyCategory', func_get_args(), $pluginInfo) : parent::applyCategory();
    }
