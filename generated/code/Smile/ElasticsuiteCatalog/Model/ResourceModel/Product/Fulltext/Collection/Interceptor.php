...
class Interceptor extends \Smile\ElasticsuiteCatalog\Model\ResourceModel\Product\Fulltext\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'resetOrder');
        return $pluginInfo ? $this->___callPlugins('resetOrder', func_get_args(), $pluginInfo) : parent::resetOrder();
    }
     ...
     * {@inheritdoc}
     */
    public function addQueryFilter(\Smile\ElasticsuiteCore\Search\Request\QueryInterface $queryFilter)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addQueryFilter');
        return $pluginInfo ? $this->___callPlugins('addQueryFilter', func_get_args(), $pluginInfo) : parent::addQueryFilter($queryFilter);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSearchQuery');
        return $pluginInfo ? $this->___callPlugins('setSearchQuery', func_get_args(), $pluginInfo) : parent::setSearchQuery($query);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isSpellchecked');
        return $pluginInfo ? $this->___callPlugins('isSpellchecked', func_get_args(), $pluginInfo) : parent::isSpellchecked();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addIsInStockFilter');
        return $pluginInfo ? $this->___callPlugins('addIsInStockFilter', func_get_args(), $pluginInfo) : parent::addIsInStockFilter();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSortFilterParameters');
        return $pluginInfo ? $this->___callPlugins('addSortFilterParameters', func_get_args(), $pluginInfo) : parent::addSortFilterParameters($sortName, $sortField, $nestedPath, $nestedFilter);
    }
